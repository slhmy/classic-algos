...
void dijkstra() {
    ...
    priority_queue<int, vector<int>, decltype(&compareDijDistance)> nearestDistanceQueue(compareDijDistance);
    // to avoid redundant update for the same node, use a visit list to control it
